...
| **P6.4f** | ⏸ *Optional, DEFERRED by the owner (2026-08-29)*: **the proposal** — candidates from typed labels only, each an explicit ✓. Measured before offering it: **0 of 154 shelves carry a label and 0 of 11 bookcases are named**, so it would propose nothing until naming starts. | S | quality, ux, security |
